...
namespace BezeroenAPP
{
    public partial class APP : Form
    {
        ...
        private void ErreserbakKargatu()
        {
            ...
            panelReservas.Controls.Add(flowLayoutPanel);
                ...
                using (MySqlCommand cmd = new MySqlCommand(query, conn))
                {
                    ...
                    using (MySqlDataReader reader = cmd.ExecuteReader())
                    {
                        if (!reader.HasRows)
                        {
                            ...
                            flowLayoutPanel.Controls.Add(lblEzErreserba);
                        }
                        else
                        {
                            while (reader.Read())
                            {
                                ...
                                {
                                    Width = panelReservas.ClientSize.Width - 20, //Margenarekin erreserbak erakutsi
                                    Height = 190,
                                    BackColor = Color.White,
                                    Margin = new Padding(10, 10, 10, 20), //Espazioa bertikala errespetatu
                                ...
                                Panel panelHeader = new Panel
                                {
                                    ...
                                    Cursor = Cursors.Hand //Clickablea dena cursorea aldatu
                                };
                                ...
                                //Erreserba panela gehitu
                                flowLayoutPanel.Controls.Add(erreserbaPanel);
                            }
                        }
                    }
                }
